...
else
{
	...
	$check = mysql_query("SELECT item,category from stash where id = '$id'");
	...
	$check = mysql_query("SELECT item from stash where id = '$id'");
	$itmnm=mysql_fetch_array($check);
	//echo "old name:";
	//echo $itmnm[0];
	//echo " ";
	...
	//updating new product name and category to the stash
	mysql_query("UPDATE stash SET item='$product', category='$category' WHERE id = '$id'");
